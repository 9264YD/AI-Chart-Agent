rom dotenv import load_dotenv, find_dotenv
    ...
    message_text = [
        {
            ...
            "content": (
                ...
                You are expected to analyse the query and determine the appropriate type of chart (e.g., bar, line, pie) that best represents the data. If 'query' does not mention information about a chart do not create a chart and leave the 'chartjs_code' value empty and respond to the user query in 'response' value.
